...
Les modèles classiques supposent souvent un monde ``parfait''. Optimiser ce scénario crée une stratégie fragile qui ne fonctionnera plus au premier aléa. L'enjeu n'est donc plus seulement d'optimiser un plan idéal, mais également d'anticiper les écarts malgré ces intertitudes, c'est la naissance de l'optimisation robuste.

Ce nouveau concept permet de poser un cadre pour décider dans l'incertain. Nous pourrions le définir de la façon suivante: l'Optimisation robuste cherche la meilleure décision qui reste faisable et performante face à toutes les incertitudes futures, quelques soient les scénarios à venir.
Nous avons deux types d'incertitude, elles peuvent être continues (température, volume de ventes) ou discrètes (scénarios définis). Les incertitudes s'appuient sur des historiques, des retours métiers ou des scénarios critiques identifiés.
...
developper sur les nouvelles méthodes 
